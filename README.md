...
Once the `conda-forge` channel has been enabled, `mkdocs-material-extensions` can be installed with:

```
conda install mkdocs-material-extensions
```

It is possible to list all of the versions of `mkdocs-material-extensions` available on your platform with:
